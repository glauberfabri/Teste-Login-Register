...
namespace MyTodoApp.Controllers
{
    ...
    public class TodoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Done,CreatedAt,LastUpteDate,User")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Done,CreatedAt,LastUpteDate,User")] Todo todo)
        {
            if (id != todo.Id)
            {
                return NotFound();
